...
function Live({ ytUrl }: LiveProps) {
    return (
        <>
            <Head title="REAPER Made Easy live meet-up" />
            <h1
                tabIndex={-1}
                ref={(e) => {
                    if (e) e.focus()
            ...
            <p>
                Welcome to March's stream, a march through the OSARA
                Configuration dialog. Today we're gonna be going through that
                sucker one option at a time, giving you a practical demo of the
                difference each option makes so you can tweak OSARA to your
                liking. Listen in, follow along, and of course, there'll be
            ...
            <p>
                We'll be taking periodic breaks throughout the stream for
                questions, comments and discussion. You can get a question to us
                using the accessible chat right here in your browser
            </p>
            <p>
                <a
            ...
            <ol>
                ...
                <li>
                    ...
                    <a
                        ...
                        rel="noopener"
                    >
                        Click here to join the REAPER Live Meet-ups channel on a
                        desktop or laptop.
                    </a>
                </li>
                <li>
            ...
            <p>
                We're streaming audio live on YouTube as a backup. It has a
                longer delay, but hey, if none of the options above have worked
                out for you, it's worth a shot, YouTube works on pretty much
                everything.
            </p>
            <p>
                Feel free to pop questions in the YouTube chat, Shay will be
                watching.
            </p>
            <iframe
                width="560"
